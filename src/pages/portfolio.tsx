    ...
    <div className="h-screen w-full bg-gradient-to-br from-matteBlack  to-black">
      <Parallax pages={5}>
        ...
        <ParallaxLayer offset={1} speed={0.8}>
          <img
            src="images/30DM - Day 23 (30s) (7).jpg"
            alt=""
        ...
        <ParallaxLayer offset={1.8} speed={0.8}>
          <img
            src="images/30DM - Day 23 (30s) (1).jpg"
            alt=""
        ...
        <ParallaxLayer offset={1} speed={0.5}>
          <img
            src="images/30DM - Day 23 (30s) (3).jpg"
            alt=""
        ...
        <ParallaxLayer offset={1} speed={0.6}>
          <img
            src="images/30DM - Day 27 (blue ivy) (4).jpg"
            alt=""
        ...
        <ParallaxLayer offset={1.2} speed={0.6}>
          <img
            src="images/30DM - Day 29 (rare) (2).jpg"
            alt=""
        ...
        <ParallaxLayer offset={1.7} speed={0.7}>
          <img
            src="images/30 DM - Day 13 (corporate affair) (1).jpg"
            alt=""
            className="w-56 h-56 pl-2 translate-x-48 drop-shadow-2xl"
          />
        </ParallaxLayer>
        <ParallaxLayer offset={3} speed={0.8}>
          <img
            src="images/30 DM - Day 13 (corporate affair) (2).jpg"
            alt=""
        ...
        <ParallaxLayer offset={2} speed={0.8}>
          <img
            src="images/30 DM - Day 13 (corporate affair) (4).jpg"
            alt=""
        ...
        <ParallaxLayer offset={2.4} speed={0.6}>
          <img
            src="images/30DM - Day 3 (hairdo) (1).jpg"
            alt=""
        ...
        <ParallaxLayer offset={2.8} speed={0.7}>
          <img
            src="images/30DM - Day 4 (buttoned up) (3).jpg"
            alt=""
            className="w-56 h-56 pl-2 translate-x-48 drop-shadow-2xl"
          />
        </ParallaxLayer>
        <ParallaxLayer offset={2.8} speed={0.7}>
          <img
            src="images/30DM - Day 4 (buttoned up) (1).jpg"
            alt=""
        ...
        <ParallaxLayer offset={3.2} speed={0.8}>
          <img
            src="images/30DM - Day 10 (Art) (7).jpg"
            alt=""
        ...
        <ParallaxLayer offset={3.3} speed={0.8}>
          <img
            src="images/30DM - Day 12 (euphoria 2) (5).jpg"
            alt=""
        ...
        <ParallaxLayer offset={3.4} speed={0.3}>
          <img
            src="images/30DM - Day 15 (dark colors) (4).jpg"
            alt=""
        ...
        <ParallaxLayer offset={3.5} speed={0.3}>
          <img
            src="images/30DM - Day 17 (glitters) (3).jpg"
            alt=""
        ...
        <ParallaxLayer offset={3.6} speed={0.2}>
          <img
            src="images/30DM - Day 22 (queen) (1).jpg"
            alt=""
        ...
        <ParallaxLayer offset={3.7} speed={0.8}>
          <img
            src="images/30DM - Day 30 (final) (2).jpg"
            alt=""
            className="w-32 h-32 pl-2 translate-x-60 translate-y-32"
          />
        </ParallaxLayer>
        <ParallaxLayer offset={3.8} speed={0.6}>
          <img src="images/highie (3).jpg" alt="" className="w-32 h-32 pl-2" />
        </ParallaxLayer>
        <ParallaxLayer offset={3.9} speed={0.6}>
          <img
            src="images/30DM - Day 24 (flowerboy) (2).jpg"
            alt=""
